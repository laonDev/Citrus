	...
	public class BGLayer extends Sprite
	{
		...
		private function onAddedToStage(e:Event):void
		{
			...
			}else
			{
				...
				lowerImage1 = new Image(Assets.getAtlas().getTexture("buildingLayer" + _layer));
				lowerImage2 = new Image(Assets.getAtlas().getTexture("buildingLayer" + _layer));
			}
			lowerImage1.x = 0;
			lowerImage1.y = stage.stageHeight - lowerImage1.height;
			lowerImage2.x = lowerImage1.width;
